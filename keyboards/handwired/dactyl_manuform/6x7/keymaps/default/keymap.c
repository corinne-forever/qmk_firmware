...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x7(
        ...
        RAISE  , KC_LCTL , KC_Z   , KC_X  , KC_C  , KC_V   , KC_B    ,                         KC_N  , KC_M   , KC_COMM, KC_DOT,KC_SLSH, KC_LCTL  , LOWER  ,
                                    KC_LBRC,KC_RBRC,                                                            KC_PLUS, KC_EQL,
                                                    KC_SPC , _______ ,                         KC_ENT , _______,
    ...
    [_RAISE] = LAYOUT_6x7(
        RESET  ,KC_F12 , KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 ,                        KC_F6  , KC_F7 , KC_F8 , KC_F9 ,KC_F10 ,KC_F11 , RESET  ,
